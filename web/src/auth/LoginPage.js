...
class LoginPage extends React.Component {
  ...
  render() {
    ...
    if (this.props.application === undefined && (this.props.account === undefined || this.props.account === null) && !application.enablePassword && visibleOAuthProviderItems.length === 1) {
